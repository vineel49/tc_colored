...
%**************************************************************************
 temp5 = log_alpha + log_gamma(Outputs_next(:,1),:)+repmat(LLR/2,num_states,1) + log_beta(Next_State(:,1),2:num_bit+1) ;
 ...
 temp6 = log_alpha + log_gamma(Outputs_next(:,2),:)-repmat(LLR/2,num_states,1)+ log_beta(Next_State(:,2),2:num_bit+1) ;
